...
public abstract class Entry extends ContentItem {
    ...
    //PROJETO PEP
    //Set e Get adicionado para ajudar na persistencia em JPA
    public void jpaSetOtherParticipations(List<Participation> otherParticipations) {
        this.otherParticipations = otherParticipations;
    }

    public List<Participation> jpaGetOtherParticipations() {

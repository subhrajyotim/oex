...
public class XFolder extends Locatable {
    ...
    /**
     * Sets para folders e compositions criados
     * para auxiliar na persistencia
     */
    public void setFolders(List<XFolder> folders) {
        this.folders = folders;
    }

    public void setComposition(List<XComposition> compositions) {
        this.compositions = compositions;
    }

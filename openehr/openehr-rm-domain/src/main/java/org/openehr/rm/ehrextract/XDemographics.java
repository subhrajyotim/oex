 ...
 *
 * file:        "$URL: http://svn.openehr.org/ref_impl_java/BRANCHES/RM-1.0-update/libraries/src/java/org/openehr/rm/ehrextract/XDemographics.java $"
...
public class XDemographics implements java.io.Serializable {
    ...
    /**
     * Criado get e set para parties para auxiliar na persistencia.
     */
    public void setParties(Map<ObjectID, Party> parties) {
        this.parties = parties;
    }

...
public abstract class Version<T> extends RMObject {
    ...
    public Version(ObjectVersionID uid, ObjectVersionID precedingVersionID,
        ...
        if (!terminologyService.terminology(TerminologyService.OPENEHR).codesForGroupName("version lifecycle state", "en").contains(lifeCycleState.getDefiningCode())) {
    ...
    public void setDataJPA(Object obj) {
        this.data = (T) obj;
    }
    ...
    private Map<Long, Class> dataTipo;

    public Map<Long, Class> getDataTipo() {
        return dataTipo;
    }

    public void setDataTipo(Map<Long, Class> dataTipo) {

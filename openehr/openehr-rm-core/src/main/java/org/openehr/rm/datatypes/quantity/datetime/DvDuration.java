...
public final class DvDuration extends DvAmount<DvDuration> {
	...
	// Comentário removido para persistência usando JPA
	private int years, months, weeks, days, hours, minutes, seconds;
	
	public void jpaSetYears(int years) {
		this.years = years;
	}

	public void jpaSetMonths(int months) {
		this.months = months;
	}

	public void jpaSetWeeks(int weeks) {
		this.weeks = weeks;
	}

	public void jpaSetDays(int days) {
		this.days = days;
	}

	public void jpaSetHours(int hours) {
		this.hours = hours;
	}

	public void jpaSetMinutes(int minutes) {
		this.minutes = minutes;
	}

	public void jpaSetSeconds(int seconds) {
		this.seconds = seconds;
	}

	public void jpaSetFractionalSeconds(double fractionalSeconds) {
		this.fractionalSeconds = fractionalSeconds;
	}

    public void jpaSetPeriod(Period period) {
        this.period = period;
    }

    public int jpaGetYear() {
        return this.years;
    }

    public int jpaGetMonths() {
        return this.months;
    }

    public int jpaGetWeeks() {
        return this.weeks;
    }

    public int jpaGetDays() {
        return this.days;
    }

    public int jpaGetHours() {
        return this.hours;
    }

    public int jpaGetMinutes() {
        return this.minutes;
    }

    public int jpaGetSeconds() {
        return this.seconds;
    }

    public double jpaGetFractionalSeconds() {

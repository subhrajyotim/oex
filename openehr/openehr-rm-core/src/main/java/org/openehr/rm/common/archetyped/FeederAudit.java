...
public final class FeederAudit extends RMObject {
   ...
   /**
    ...
    //Sets adicionado para persistencia em JPA
    public void jpaSetFeederSystemItemIds(List<DvIdentifier> feederSystemItemIDs) {
        this.feederSystemItemIds = feederSystemItemIDs;
    }

    public void jpaSetOriginatingSystemItemIds(List<DvIdentifier> originatingSystemItemIDs) {
        this.originatingSystemItemIds = originatingSystemItemIDs;
    }

...
public class VersionedObject<T> extends RMObject {
    ...
    public SortedMap<DvDateTime, Version<T>> getTimeVersionMapJPA() {
        return timeVersionMap;
    }

    public void setTimeVersionMapJPA(SortedMap<DvDateTime, Version<T>> timeVersionMap) {
    ...
    public List<Version<T>> getJPAValuesId() {
        return JPAValuesId;
    }

    public void setJPAValuesId(List<Version<T>> JPAValuesId) {
        this.JPAValuesId = JPAValuesId;
    }

    public List<Version<T>> getJPAValuesTime() {
        return JPAValuesTime;
    }

    public void setJPAValuesTime(List<Version<T>> JPAValuesTime) {
        this.JPAValuesTime = JPAValuesTime;
    }

    public HashMap<ObjectVersionID, Version<T>> getIdVersionMap() {
        return idVersionMap;
    }

    public void setIdVersionMap(HashMap<ObjectVersionID, Version<T>> idVersionMap) {

 ...
 *
 * file:        "$URL: http://svn.openehr.org/ref_impl_java/BRANCHES/RM-1.0-update/libraries/src/java/org/openehr/rm/ehrextract/XAccessControl.java $"
...
public class XAccessControl implements java.io.Serializable {
    ...
    //PROJETO PEP
    private List<ObjectID> keysJPA;
    private byte[] valuesJPA;

    public byte[] getValuesJPA() {
        return valuesJPA;
    }

    public void setValuesJPA(byte[] valuesJPA) {
        this.valuesJPA = valuesJPA;
    }

    public Map<ObjectID, Object> getGroups() {
        return groups;
    }

    public void setGroups(Map<ObjectID, Object> groups) {
        this.groups = groups;
    }

    public List<ObjectID> getKeysJPA() {
        return keysJPA;
    }

    public void setKeysJPA(List<ObjectID> keysJPA) {
        this.keysJPA = keysJPA;
    }
}
